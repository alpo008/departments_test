...
return [
    ...
    */
    ...
    'alpha_dash' => 'Поле :attribute может состоять из латиницы, символов "-" и "_".',
    ...
    'between' => [
        ...
        'string' => 'Поле :attribute может содержать от :min до :max символов.',
    ...
    'in' => 'Недопустимый атрибут :attribute.',
    ...
    'mimes' => 'Допускаются следующие форматы: :values.',
    'mimetypes' => 'Допускается один из следующих типов файлов: :values.',
    'min' => [
        'numeric' => 'Значение :attribute не должно быть меньше :min.',
        'file' => 'Размер файла не должен быть меньше :min килобайт.',
